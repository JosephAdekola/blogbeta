        ...
        <div className='border w-full h-[10vh] bg-gray-500 text-white flex 
            ...
            <div className='  '>
                <ul className=' hidden lg:flex gap-5  w-fit ml-auto text-xl '>
                    ...
                    <li className={ user.role ? 'inline-block ' : 'inline-block'}>
                        <NavLink className={({ isActive }) => isActive ? 'bg-gray-700 rounded p-3' :
                                    'bg-gray 500'} to='/addarticle'>
                                Add-Article
                        </NavLink></li>
                        ...
                        <div>
                            ...
                            <ul className=' text-xl lg:hidden absolute text-center top-[10vh] 
                                ...
                                <li onClick={() => setShowMenu(false)}
                                    className={user.role? 'bg-gray-500 rounded p-3 w-fit mx-auto hover:bg-gray-700' : 'bg-gray-500 rounded p-3 w-fit mx-auto hover:bg-gray-700'}>
                                    <NavLink className={({ isActive }) => isActive ? 'bg-gray-700 rounded p-3' :
                                                'bg-gray 500'} to='addarticle'>
                                            Add-Article
                                    </NavLink></li>
